module Nuker
  ...
  class Feature < ::ActiveRecord::Base
    ...
    include Nuker::Cucumber::Ast::Adapter::FeatureAdapter
    include Nuker::Cucumber::Formatter::FeatureFormatter
    include Nuker::Taggable

    set_observed_callback_methods :save
    set_scenario_adapter Nuker::Scenario

    belongs_to :project, :class_name => "Nuker::Project"
    belongs_to :folder, :class_name => "Nuker::Folder"
    has_many :description_lines, :class_name => "Nuker::FeatureDescriptionLine", :order => :position, :dependent => :destroy
    has_many :scenarios, :class_name => "Nuker::Scenario", :order => :position, :dependent => :destroy
